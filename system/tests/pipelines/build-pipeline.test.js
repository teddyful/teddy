...
const publicResources = [
    ...
    'sitemap.xml', 
    'about/index.html', 
    `assets/collection/en/content.cfg.json`, 
    `assets/collection/en/content.ctx.json`, 
    `assets/collection/en/content.map.json`, 
    `assets/collection/en/description.cfg.json`, 
    `assets/collection/en/description.ctx.json`, 
    `assets/collection/en/description.map.json`, 
    `assets/collection/en/name.cfg.json`, 
    `assets/collection/en/name.ctx.json`, 
    `assets/collection/en/name.map.json`, 
    `assets/collection/en/reg.json`, 
    `assets/collection/en/store.json`, 
    `assets/collection/en/tag.json`, 
    `assets/collection/ja/content.cfg.json`, 
    `assets/collection/ja/content.ctx.json`, 
    `assets/collection/ja/content.map.json`, 
    `assets/collection/ja/description.cfg.json`, 
    `assets/collection/ja/description.ctx.json`, 
    `assets/collection/ja/description.map.json`, 
    `assets/collection/ja/name.cfg.json`, 
    `assets/collection/ja/name.ctx.json`, 
    `assets/collection/ja/name.map.json`, 
    `assets/collection/ja/reg.json`, 
    `assets/collection/ja/store.json`, 
    `assets/collection/ja/tag.json`, 
    `assets/collection/zh-tw/content.cfg.json`, 
    `assets/collection/zh-tw/content.ctx.json`, 
    `assets/collection/zh-tw/content.map.json`, 
    `assets/collection/zh-tw/description.cfg.json`, 
    `assets/collection/zh-tw/description.ctx.json`, 
    `assets/collection/zh-tw/description.map.json`, 
    `assets/collection/zh-tw/name.cfg.json`, 
    `assets/collection/zh-tw/name.ctx.json`, 
    `assets/collection/zh-tw/name.map.json`, 
    `assets/collection/zh-tw/reg.json`, 
    `assets/collection/zh-tw/store.json`, 
    `assets/collection/zh-tw/tag.json`, 
    `assets/css/style.css`, 
    `assets/css/vendors/bootstrap/5.3.3/bootstrap.min.css`, 
