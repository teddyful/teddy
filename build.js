...
program.name(packageConfig.name)
    ...
    .option('--dist-dir-build-id', 'Use the build ID as the name of the distribution sub-directory', false)
    .option('--dist-dir-none', 'Omit the intermediate distribution sub-directory', false)
